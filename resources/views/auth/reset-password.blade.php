    ...
    <div class="auth-inner my-2">
        ...
        <div class="card mb-0">
            <div class="card-body">
                ...
                <form id="reset-password-form" class="auth-reset-password-form mt-2" action="{{route('password.update')}}" method="POST" novalidate>
                    <div class="mb-1">
                        <div class="d-flex justify-content-between">
                            <label class="form-label" for="reset-password-new">Your Email</label>
                        </div>
                        <div class="input-group input-group-merge form-password-toggle">
                            <input type="text" class="form-control form-control-merge" id="email" name="email" value={{$user}} placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="reset-password-new" tabindex="1" autofocus="false"  readonly/>
                    ...
                    <button type="submit" id="resetPassword" class="btn btn-primary w-100" tabindex="3">Set New Password</button>
                </form>
