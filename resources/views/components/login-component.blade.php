                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            <a href="#" class="brand-logo">
                                ...
                                <h2 class="brand-text text-primary ms-1">Al-Sairaat</h2>
                            </a>

                            <h4 class="card-title mb-1">Welcome to Al-Sairaat! 👋</h4>
                            <p class="card-text mb-2">Please sign-in to your account and start the adventure</p>

                            <form class="auth-login-form mt-2" action="{{ route('dashboard.index') }}" method="GET">
                                <div class="mb-1">
