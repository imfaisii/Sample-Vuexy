            ...
            <ul class="nav navbar-nav align-items-center ms-auto">
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user"><a
                            ...
                            href="app-email.html')}}"><i class="me-50" data-feather="mail"></i> Inbox</a><a
                            class="dropdown-item" href="app-todo.html')}}"><i class="me-50"
                                data-feather="check-square"></i> Task</a><a class="dropdown-item"
                            href="app-chat.html')}}"><i class="me-50" data-feather="message-square"></i>
                            Chats</a>
                        <div class="dropdown-divider"></div><a class="dropdown-item"
                            ...
                            href="auth-login-cover.html')}}"><i class="me-50" data-feather="power"></i>
                            Logout</a>
                    </div>
                </li>
            </ul>
                        ...
                        <li><a class="d-flex align-items-center" href="#"><i data-feather="circle"></i><span
                            ...
                            <ul class="menu-content">
                                ...
                                <li><a class="d-flex align-items-center"
                                        href="app-user-view-notifications.html')}}"><span
                                            class="menu-item text-truncate"
                                            data-i18n="Notifications">Notifications</span></a>
                                </li>
                                <li><a class="d-flex align-items-center"
                                        href="app-user-view-connections.html')}}"><span class="menu-item text-truncate"
