...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click"
        ...
        <div class="navbar-container d-flex content">
            <div class="bookmark-wrapper d-flex align-items-center">
                ...
                <ul class="nav navbar-nav bookmark-icons">
                    <li class="nav-item d-none d-lg-block"><a class="nav-link"
                            href="{{ route('dashboard.calender') }}" data-bs-toggle="tooltip"
            ...
            <ul class="nav navbar-nav align-items-center ms-auto">
                    ...
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                        <li class="dropdown-menu-header">
                            <div class="dropdown-header d-flex">
                                ...
                                <div class="badge rounded-pill badge-light-primary">5 New</div>
                            </div>
                        </li>
                        <li class="scrollable-container media-list"><a class="d-flex" href="#">
                                <div class="list-item d-flex align-items-start">
                                    ...
                                    <div class="list-item-body flex-grow-1">
                                        <p class="media-heading"><span class="fw-bolder">Congratulation ! Someone
                                                Bought the plot
                                                🎉</span>Yay!</p><small class="notification-text">An investor</small>
                                    </div>
                                </div>
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                        ...
                        aria-expanded="false">
                        <div class="user-nav d-sm-flex d-none"><span class="user-name fw-bolder">Saad Malik</span><span
                    ...
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user"><a
                        ...
                        <div class="dropdown-divider"></div><a class="dropdown-item" href="#"><i
                            ...
                            Settings</a><a class="dropdown-item" href="{{ route('login') }}"><i
    ...
    <ul class="main-search-list-defaultlist d-none">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100" href="#">
                <div class="d-flex align-items-center">
                    ...
                    <div class="search-data">
                        <p class="search-data-title mb-0">Saad Malik</p><small class="text-muted">UI
                            designer</small>
                    </div>
                </div>
            </a></li>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="@if (Route::is('dashboard.index')) active @endif nav-item" style="margin-top: 8%"><a
                ...
                <li class="navigation-header"><span data-i18n="Apps &amp; Pages">Society Management</span><i
                        data-feather="more-horizontal"></i>
                </li>
                <li class="@if (Route::is(['dashboard.society-admin.render-create', 'dashboard.society-admin.render-index'])) active @endif nav-item"><a class="d-flex align-items-center" href="#"><i
                            data-feather="box"></i><span class="menu-title text-truncate" data-i18n="Invoice">Society
                            Admins</span></a>
                    <ul class="menu-content">
                        <li><a class="d-flex align-items-center"
                                href="{{ route('dashboard.society-admin.render-create') }}"><i
                                    data-feather="plus-circle"></i><span class="menu-item text-truncate"
                                    data-i18n="List">Make Admins</span></a>
                        </li>
                        <li><a class="d-flex align-items-center"
                                href="{{ route('dashboard.society-admin.index') }}"><i data-feather="eye"></i><span
                                    class="menu-item text-truncate" data-i18n="Preview">View Admin</span></a>
                        </li>
                    </ul>
                </li>

                <li class=" navigation-header"><span data-i18n="Apps &amp; Pages">Housing Management</span><i
                        data-feather="more-horizontal"></i>
                </li>
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i
                            data-feather="home"></i><span class="menu-title text-truncate"
                            data-i18n="Invoice">Configure Housing Society</span></a>
                    <ul class="menu-content">
                        <li><a class="d-flex align-items-center" href="#"><i data-feather="plus-circle"></i><span
                                    class="menu-item text-truncate" data-i18n="List">Add a Society</span></a>
                        </li>
                        <li><a class="d-flex align-items-center" href="#"><i data-feather="eye"></i><span
                                    class="menu-item text-truncate" data-i18n="Preview">View Societies</span></a>
                        </li>
                        <li><a class="d-flex align-items-center" href="#"><i data-feather="plus-circle"></i><span
                                    class="menu-item text-truncate" data-i18n="Preview">Add Plot</span></a>
                        </li>
                        <li><a class="d-flex align-items-center" href="#"><i data-feather="eye"></i><span
                                    class="menu-item text-truncate" data-i18n="Preview">View Plot</span></a>
                        </li>
                        <li><a class="d-flex align-items-center" href="#"><i data-feather="check"></i><span
                                    class="menu-item text-truncate" data-i18n="Preview">Sell Plot</span></a>
                        </li>
                        <li><a class="d-flex align-items-center" href="#"><i data-feather="edit"></i><span
                                    class="menu-item text-truncate" data-i18n="Preview">View Sell Histories</span></a>
                        </li>
                    </ul>
                </li>
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i
                    ...
                    <ul class="menu-content">
                        <li><a class="d-flex align-items-center" href="#"><i data-feather="user"></i><span
                                    class="menu-item text-truncate" data-i18n="List">Add
                                    User</span></a>
                        </li>
                        <li><a class="d-flex align-items-center" href="#"><i data-feather="eye"></i><span
                                    class="menu-item text-truncate" data-i18n="Preview">View Users</span></a>
                        </li>
                    </ul>
                </li>

                <li class=" navigation-header"><span data-i18n="Apps &amp; Pages">Finance &amp; Investments</span><i
                        data-feather="more-horizontal"></i>
                </li>
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i
                            data-feather="book-open"></i><span class="menu-title text-truncate"
                            data-i18n="Invoice">Investments</span></a>
                    <ul class="menu-content">
                        <li><a class="d-flex align-items-center" href="#"><i data-feather="plus-circle"></i><span
                                    class="menu-item text-truncate" data-i18n="List">Add
                                    an Investment</span></a>
                        </li>
                        <li><a class="d-flex align-items-center" href="#"><i data-feather="eye"></i><span
                                    class="menu-item text-truncate" data-i18n="Preview">View Investment</span></a>
                        </li>
                    </ul>
                </li>
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i
                            ...
                            data-i18n="Invoice">Expenses</span></a>
                    <ul class="menu-content">
                        <li><a class="d-flex align-items-center" href="#"><i data-feather="plus-circle"></i><span
                                    class="menu-item text-truncate" data-i18n="List">Add
                                    an Expense</span></a>
                        ...
                        <li><a class="d-flex align-items-center" href="#"><i data-feather="eye"></i><span
                                    class="menu-item text-truncate" data-i18n="Preview">View Expenses</span></a>
                        </li>
                        <li><a class="d-flex align-items-center" href="#"><i data-feather="smartphone"></i><span
                                    class="menu-item text-truncate" data-i18n="Preview">Calculate an
                                    Investment</span></a>
                        </li>
                    </ul>
                </li>
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i
                            ...
                            data-i18n="Invoice">Profit</span></a>
                    <ul class="menu-content">
                        <li><a class="d-flex align-items-center" href="#"><i data-feather="plus-circle"></i><span
                                    class="menu-item text-truncate" data-i18n="List">Add
                                    Profit</span></a>
                        ...
                        <li><a class="d-flex align-items-center" href="#"><i data-feather="eye"></i><span
                                    class="menu-item text-truncate" data-i18n="Preview">View Profits</span></a>
                        </li>
                    </ul>
                </li>

                <li class=" navigation-header"><span data-i18n="Apps &amp; Pages">System Services</span><i
                        data-feather="more-horizontal"></i>
                </li>
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i
                            data-feather="server"></i><span class="menu-title text-truncate" data-i18n="Invoice">System
                            Logs</span></a>
                    <ul class="menu-content">
                        <li><a class="d-flex align-items-center" href="#"><i data-feather="check"></i><span
                                    class="menu-item text-truncate" data-i18n="List">Check Log Book</span></a>
                        </li>
                        <li><a class="d-flex align-items-center" href="#"><i data-feather="delete"></i><span
                                    class="menu-item text-truncate" data-i18n="Preview">Clear Log Book</span></a>
                        </li>
                    </ul>
                </li>
    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix mb-0"><span class="float-md-start d-block d-md-inline-block mt-25">COPYRIGHT &copy; 2021<a
                    class="ms-25" href="#" target="_blank">RevoBP</a><span class="d-none d-sm-inline-block">,
                    All rights
